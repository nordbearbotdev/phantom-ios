...
class ATCPhantomUserAdapter: ATCGenericCollectionRowAdapter {
    ...
    func configure(cell: UICollectionViewCell, with object: ATCGenericBaseModel) {
        if let user = object as? ATCUser, let cell = cell as? ATCPhantomUserCollectionViewCell {
    ...
    func cellClass() -> UICollectionViewCell.Type {
        return ATCPhantomUserCollectionViewCell.self
    }
